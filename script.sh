...
mkdir -p $HOME/jshell
echo "void print(Object o){ System.out.print(o.toString());}" > $HOME/jshell/printing.jshell
echo "void println(Object o){ System.out.println(o.toString());}" >> $HOME/jshell/printing.jshell
cd /tmp
...
python3 install.py --sys-prefix --startup-scripts-path ~/jshell/printing.jshell
